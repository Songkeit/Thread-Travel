...
def settingApp():
    app.title('ThreadTravel')

def captain():
    button = Button(f1,text='captain room', bg = 'cyan', height = 8,state=DISABLED, borderwidth = 0,width = 45).pack()

def engine():
    button = Button(f3,text='engine room', bg = 'lightgreen', height = 8,state=DISABLED, borderwidth = 0, width = 45).pack()
